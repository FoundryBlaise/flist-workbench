...
SAMPLE_DESCRIPTION = (
    ...
    "\n"
    "The full-width tabs strip + this BBCode toolbar both sit above\n"
    "the editor and preview. Use the [b]Code / Split / Preview[/b]\n"
    "buttons on the right of the toolbar to switch how the row\n"
...
def main() -> None:
    ...
    # Pre-populate the eicon catalog cache so the sidecar doesn't have
    # to hit xariah.net before the renderer can use the picker. The
    # set is intentionally small but realistic-looking.
    eicon_names = [

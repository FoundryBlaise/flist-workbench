...
async function copyImageToClipboard(
  ...
  try {
    ...
    if (fetched && fetched.bytes.byteLength > 0) {
      ...
      // Copy into a plain ArrayBuffer first. The bytes arrive over IPC
      // as Uint8Array<ArrayBufferLike>, and BlobPart wants a view
      // backed by an ArrayBuffer specifically — a SharedArrayBuffer
      // would not qualify, so TypeScript rejects the union.
